...
function Main(props) {
    ...
    async function refreshBalances(wallet) {
        ...
        const bankInterestVal = await BANK.methods.getMyInterest().call({ from: wallet });
        setBankInterest(web3.utils.fromWei(bankInterestVal, 'ether'));
    }
...

            {
                wallet ?
                    ...
                    <section>
                        ...
                        <p><b>Interest Given</b> = {bankInterest} ETH</p>
